...
{window.innerWidth <=400? <div>

  <div className="text-center my-5">
    <img src={one} style={{width:"50%"}}></img>
  </div>

  <h2 className="display-3  text-center mx-4 border " style={{color:"red"}} > Please Switch into Desktop Mode for better Expreience</h2>
